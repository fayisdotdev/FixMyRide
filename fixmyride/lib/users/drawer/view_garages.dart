...
class ViewGaragesPage extends StatefulWidget {
  const ViewGaragesPage({super.key});

  @override
  State<ViewGaragesPage> createState() => _ViewGaragesPageState();
}

class _ViewGaragesPageState extends State<ViewGaragesPage> {
