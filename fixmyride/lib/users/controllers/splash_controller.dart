...
import 'package:fixmyride/seller/seller_homepage.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import 'package:fixmyride/users/screens/home_page.dart';
  ...
  Future<void> _navigateUser() async {
    ...
    if (user != null) {
      ...
      try {
        ...
        final sellerDoc = await firestore.collection('sellers').doc(uid).get();
        if (sellerDoc.exists) {
          // if It's a regular user
          final loginController = Get.put(LoginRegisterController());
          loginController.userName.value = sellerDoc.data()?['sellerName'] ?? '';
