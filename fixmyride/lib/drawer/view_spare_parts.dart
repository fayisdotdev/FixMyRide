...
class ViewSparePartsPage extends StatefulWidget {
  const ViewSparePartsPage({super.key});

  @override
  State<ViewSparePartsPage> createState() => _ViewSparePartsPageState();
}

class _ViewSparePartsPageState extends State<ViewSparePartsPage> {
